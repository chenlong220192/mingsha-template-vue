...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='代码生成业务表字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_login_log` VALUES (1,'admin','10.1.1.243','内网IP','Chrome 12','Mac OS X','0','登录成功','2024-08-03 00:33:00');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2036 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_oper_log` VALUES (44,'操作日志',3,'site.mingsha.web.controller.monitor.SysOperlogController.remove()','DELETE',1,'admin','研发部','/monitor/operlog/43,2','10.1.1.243','内网IP','{}','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2024-08-03 00:36:44',6);
...
-- Dump completed on 2024-08-03  0:40:21
