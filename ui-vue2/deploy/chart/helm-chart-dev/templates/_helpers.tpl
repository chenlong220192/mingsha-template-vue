...
{{- define "spring-boot.release.name" -}}
...
*/}}
{{- define "spring-boot.kubeVersion" -}}
...
*/}}
{{- define "spring-boot.ingress.apiVersion" -}}
  {{- if and (.Capabilities.APIVersions.Has "networking.k8s.io/v1") (semverCompare ">= 1.19.x" (include "spring-boot.kubeVersion" .)) -}}
