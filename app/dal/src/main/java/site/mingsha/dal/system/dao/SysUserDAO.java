...
public interface SysUserDAO {
     ...
     * @return 用户信息集合信息
     */
    public List<SysUserDO> selectUserList(SysUserDO sysUserDO);
     ...
     * @return 结果
     */
    public SysUserDO checkUserNameUnique(String userName);
     ...
     * @return 结果
     */
    public SysUserDO checkPhoneUnique(String phonenumber);
