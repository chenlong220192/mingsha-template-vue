...
import site.mingsha.biz.task.quartz.QuartzDisallowConcurrentExecution;
import site.mingsha.biz.task.quartz.QuartzJobExecution;
...
import site.mingsha.common.exception.job.TaskException.Code;
...
public class ScheduleUtils {
     ...
     * @return 具体执行任务类
     */
    private static Class<? extends Job> getQuartzJobClass(SysJobDO sysJobDO) {
        boolean isConcurrent = "0".equals(sysJobDO.getConcurrent());
     ...
     * 创建定时任务
     */
    public static void createScheduleJob(Scheduler scheduler, SysJobDO job) throws SchedulerException, TaskException {
     ...
     * 设置定时任务策略
     */
    public static CronScheduleBuilder handleCronScheduleMisfirePolicy(SysJobDO job, CronScheduleBuilder cb) throws TaskException {
