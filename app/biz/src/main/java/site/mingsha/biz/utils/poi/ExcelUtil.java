package site.mingsha.biz.utils.poi;
...
import site.mingsha.common.annotation.Excel.ColumnType;
import site.mingsha.common.annotation.Excel.Type;
import site.mingsha.common.annotation.Excels;
import site.mingsha.common.config.MingshaConfig;
import site.mingsha.common.model.response.AjaxResponseDTO;
import site.mingsha.common.utils.poi.ExcelHandlerAdapter;
import site.mingsha.common.utils.text.Convert;
import site.mingsha.common.exception.UtilException;
...
import site.mingsha.common.utils.file.FileTypeUtils;
import site.mingsha.common.utils.file.FileUtils;
import site.mingsha.common.utils.file.ImageUtils;
import site.mingsha.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public AjaxResponseDTO exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public AjaxResponseDTO exportExcel(List<T> list, String sheetName, String title) {
     ...
     * @return 结果
     */
    public AjaxResponseDTO importTemplateExcel(String sheetName) {
     ...
     * @return 结果
     */
    public AjaxResponseDTO importTemplateExcel(String sheetName, String title) {
     ...
     * @return 结果
     */
    public AjaxResponseDTO exportExcel() {
        ...
        try {
            ...
            wb.write(out);
            return AjaxResponseDTO.success(filename);
        } catch (Exception e) {
            log.error("导出Excel异常{}", e.getMessage());
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = MingshaConfig.getDownloadPath() + filename;
